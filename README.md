...
- Compartilhar ainda mais código entre Web/Mobile (ex.: estratégia de fetch) via pacote interno.
- Adicionar estados de skeleton animados e testes e2e (Cypress/Appium).
- Expor métricas de performance (Web Vitals) e monitorar latência das APIs.

---

Qualquer dúvida sobre decisões, trade-offs ou extensões sugeridas pode ser discutida durante a apresentação.
